...
print()
print('There are currently ' + str(active_currencies_string) + ' active cryptocurrencies and ' + str(active_markets_string))
print('The global cap of all cryptos is ' + str(global_cap_string) + 'and the 24h global volume is ' + str(global_volume_string))
